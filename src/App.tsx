...
function App() {
  ...
  return (
    <div ref={mainContainerRef} className="h-screen overflow-y-auto custom-scrollbar">
      {/* Header */}
      <div 
        style={{ backgroundColor: "rgb(20, 20, 30)" }} // Updated header background color
      >
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-center">
            ...
            />
            <h1 className="text-5xl font-bold font-mono" style={{ color: "rgb(220, 155, 33)" }}>ABO ELEZZ </h1>
          </div>
        </div>
      </div>
      ...
      {/* Footer */}
      <div className="sticky bottom-0 shadow-lg" style={{ backgroundColor: "rgb(34, 42, 65)" }}>
